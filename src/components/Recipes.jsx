...
const Recipes = ()=> {
    return (
        <section className="categories categories-grid spad">
                        ...
                        <div className="row">
                            <div className="col-lg-8 col-md-8">
                                <div className="breadcrumb__text">
                                    <h2>Категория: <span>Рецепты</span></h2>
                                    ...
                                    <div className="col-lg-6 col-md-6 col-sm-6">
                                        <div className="categories__post__item">
                                            ...
                                            <div className="categories__post__item__text">
                                                ...
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                                                    eiusmod
                                                    tempor incididunt dolore magna aliqua. Quis ipsum suspendisse
                                                    ultrices
                                                    gravida...</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="categories__post__item__plain set-bg"
                                            ...
                                            <div className="categories__post__item__text">
                                                ...
                                                <h3><a href="#">This Summer Snacking Cake Is theSweetest Excuse
                                                    to...</a>
                                                </h3>
                                                <div className="post__social">
                                                    <span>Share</span>
                                                    <a href="#"><i className="fa fa-facebook"></i> <span>82</span></a>
                                                    <a href="#"><i className="fa fa-twitter"></i> <span>24</span></a>
                                                    <a href="#"><i className="fa fa-envelope-o"></i> <span>08</span></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="categories__post__item">
                                    ...
                                    <div className="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <div className="categories__post__item__small">
                                            <img src="img/categories/categories-post/quote.png" alt=""/>
                                                <p>Lorem ipsum dolor amet, consectetur adipiscing elit, sed do eiusmod
                                                    tempor
                                ...
                                <div className="sidebar__item">
                                    ...
                                    <div className="sidebar__item__categories">
                                        ...
                                        <ul>
                                            ...
                                            <li className="p-left"><a href="#">Smothie <span>25</span></a></li>
                                            <li className="p-left"><a href="#">Drinks <span>36</span></a></li>
                                            <li className="p-left"><a href="#">Cakes <span>15</span></a></li>
                                    ...
                                    <div className="sidebar__subscribe__item">
                                        ...
                                        <p>Subscribe to our newsletter and get our newest updates right on your
                                            inbox.</p>
                                        <form action="#">
